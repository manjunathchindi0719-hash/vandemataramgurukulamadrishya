        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto items-center">
          ...
          <div className="space-y-4 flex flex-col items-center md:items-start">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full max-w-xs px-5 py-3 rounded-lg font-semibold text-lg bg-primary text-primary-foreground shadow-[var(--shadow-soft)] hover:shadow-[var(--shadow-medium)] transition-[var(--transition-smooth)] hover:scale-[1.02] active:scale-[0.98] text-center"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full max-w-xs px-5 py-3 rounded-lg font-semibold text-lg bg-secondary text-secondary-foreground shadow-[var(--shadow-soft)] hover:shadow-[var(--shadow-medium)] transition-[var(--transition-smooth)] hover:scale-[1.02] active:scale-[0.98] text-center"
            >
              For Donation / Seva
            </a>
          </div>
